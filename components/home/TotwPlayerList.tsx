...
interface TotwPlayerListProps {
  totw: HomeTotw;
}

export function TotwPlayerList({ totw }: TotwPlayerListProps) {
  ...
  return (
    <div className="totw-player-list">
      <ul className="totw-player-list-grid">
      ...
      {motwAthleteId && (
        <Link href={`/atletas/${motwAthleteId}`} className="totw-mobile-motw">
